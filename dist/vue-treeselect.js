...
module.exports = require("@fishtank/icons-vue");
...
var MENU_BUFFER = 40;
// CONCATENATED MODULE: ./src/mixins/fttreeselectMixin.js
/* harmony default export */ var fttreeselectMixin = ({
...
// EXTERNAL MODULE: external "@fishtank/icons-vue"
var icons_vue_ = __webpack_require__(14);

// EXTERNAL MODULE: external "babel-helper-vue-jsx-merge-props"
var external_babel_helper_vue_jsx_merge_props_ = __webpack_require__(15);
...
/* harmony default export */ var Controlvue_type_script_lang_js_ = ({
  ...
  render: function render() {
    ...
    var Controls = instance.hideControl === true ? h("div", {
...
var arrowPlaceholder, checkMark;
var Option = {
  ...
  methods: {
    ...
    renderArrow: function renderArrow() {
      ...
      if (node.isBranch) {
        ...
        }, [h("transition", transitionProps, [h(icons_vue_["CaretDown24"], {
          "class": arrowClass
        })])]);
      }
    ...
    renderCheckbox: function renderCheckbox() {
      ...
      var allVisibleIsSelected = [];
      var selectedNodeIds = [];
      instance.selectedNodes.forEach(function (sNode) {
        selectedNodeIds.push(sNode.id);
      });
      allVisibleIsSelected = instance.visibleOptionIds.filter(function (vOp) {
        return !selectedNodeIds.includes(vOp);
      });
      if (node.children !== undefined) hasChildren = true;
      var checkedState = instance.forest.checkedStateMap[node.id];
      var parentNodeCheckedState = node.parentNode !== null ? instance.forest.checkedStateMap[node.parentNode.id] : 0;
      var checkboxClass = {
      ...
      if (node.level === 0) {
        if (checkedState === 2) checkMark = h("span", {
          "class": "vue-treeselect__check-mark"
        }, [h(icons_vue_["CheckboxSelected24"])]);
        if (checkedState === 1) checkMark = h("span", {
          "class": "vue-treeselect__minus-mark"
        }, [h(icons_vue_["CheckboxPartial24"])]);
        if (checkedState === 0) checkMark = h("span", {
          "class": "vue-treeselect__check-mark__unselected"
        }, [h(icons_vue_["CheckboxUnselected24"])]);
      } else {
        if (allVisibleIsSelected.length > 0) {
          if (checkedState === 2 && hasChildren) checkMark = h("span", {
            "class": "vue-treeselect__check-mark"
          }, [h(icons_vue_["CheckboxSelected24"]), "a"]);
          if (checkedState === 2 && !hasChildren && parentNodeCheckedState === 2) checkMark = h("span", {
            "class": "vue-treeselect__check-mark"
          }, [h(icons_vue_["CheckboxSelectedO24"])]);
          if (checkedState === 2 && !hasChildren && parentNodeCheckedState === 1) checkMark = h("span", {
            "class": "vue-treeselect__check-mark"
          }, [h(icons_vue_["CheckboxSelected24"])]);
          if (checkedState === 1) checkMark = h("span", {
            "class": "vue-treeselect__minus-mark"
...
var external_vue_ = __webpack_require__(16);
